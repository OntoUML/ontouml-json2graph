...
Please get in touch with this software's contributors using the provided links or **preferably
** [open an issue](https://github.com/OntoUML/ontouml-json2graph/issues) in case of doubts or problems found.
